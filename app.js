...
*/
const starterPokemon1 = pokemon[0];
game.party.push(starterPokemon1);
...
*/
game.party.push(pokemon[4], pokemon[7], pokemon[10]);
// console.log(game.party);
...
*/
game.party.sort((p1, p2) => p2.hp - p1.hp);
// console.log(game.party);
